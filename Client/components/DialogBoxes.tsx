    ...
    <>
        <Dialog open={appState.isOpenAgreement} onClose={() => toggleIsOpenAgreement()} className="relative z-50">
            ...
            <DialogPanel className="max-w-lg space-y-4 border bg-white p-8 rounded-xl text-center">
                ...
                <Description>By signing up, you are creating a ShopSense account, and you agree to ShopSense <a className='text-primary-700 font-medium' href='/policy/terms&conditions'>Terms & Conditions</a> and <a className='text-primary-700 font-medium' href='/policy/privacypolicy'>Privacy Policy.</a></Description>
