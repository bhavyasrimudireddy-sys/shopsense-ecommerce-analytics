...
const OrderDetail = () => {
    ...
    const totalAmount = subTotalWithoutTax - discount + shipping + taxes;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          <div className="border p-8 rounded-xl gap-6 flex flex-col">
            ...
            <div className='grid grid-cols-2'>
              ...
              <div className='flex flex-col gap-2'>
                <p className='text-silver'>Checkout Mode</p>
                <p className='font-medium'>Portfolio Demo</p>
              </div>
            </div>
            <div className='flex flex-col gap-2'>
            <p className='text-silver'>Order Type</p>
            <p className='font-medium'>Demo commerce order</p>
            </div>
          </div>
          <div className="border p-8 rounded-xl gap-6 flex flex-col">
            ...
            <div className='flex gap-8'>
              ...
              <div className='flex flex-col gap-2'>
                ...
                <p className='font-medium'>{data.mobile_number}</p>
              </div>
            </div>
          </div>
          <div className="border p-8 rounded-xl gap-6 flex flex-col">
