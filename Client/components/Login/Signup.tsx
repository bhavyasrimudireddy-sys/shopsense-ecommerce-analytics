                                ...
                                <div className="flex flex-col gap-4 justify-between">
                                    <div className="flex items-start">
                                        ...
                                        <div onClick={()=>toggleAgreement()} className="ml-3 text-sm font-medium">
                                            <label className="text-gray-500">By signing up, you are creating a ShopSense account, and you agree to ShopSense <a className='text-primary-700 font-medium' href='/policy/terms&conditions'>Terms & Conditions</a> and <a className='text-primary-700 font-medium' href='/policy/privacypolicy'>Privacy Policy.</a></label>
                                        </div>
                                    </div>
                                    <div className="flex items-start">
                                        <div className="flex items-center h-5">
