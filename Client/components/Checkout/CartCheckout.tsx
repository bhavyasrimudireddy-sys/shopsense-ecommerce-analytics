...
import { checkoutCartProductDataHandler, createDemoCartOrderHandler } from '@/app/api/paymentSystem';
...
const CartCheckout = () => {
    ...
    async function createOrder(e:any){
        e.preventDefault();
        setloading(true);
        const createOrder = await createDemoCartOrderHandler(genUserData.current.userID)
    ...
    <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <form action="/" id='informational-form' onSubmit={createOrder} className="min-w-0 flex-1 space-y-8">
            ...
            <div className="space-y-3 rounded-xl border border-emerald-200 bg-emerald-50 p-5">
              ...
              <p className="text-sm text-gray-600">No real card or payment gateway is used. Placing the order records demo orders for the products in this cart.</p>
            </div>
