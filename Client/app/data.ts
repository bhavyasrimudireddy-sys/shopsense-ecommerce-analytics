...
const navBtns = [
    ...
    {name:"Analytics",isExtendable:false,extendables:[],catLink:'/analytics'},
    {name:"Admin",isExtendable:false,extendables:[],catLink:'/admin'},
    {name:"Compare",isExtendable:false,extendables:[],catLink:'/compare'},
...
const aboutUS= {
    section1:[
        {
            title:"About Us",
            description:"ShopSense is a portfolio commerce experience built to explore a Product Analyst question: how can better discovery, clearer decision support and measurable journeys help shoppers find the right product with less friction?",
            imgLink:"about.jpg",
            imgAlt:""
        },
        {
            title:"Our Story",
            description:"The project was customized for Bhavyasri Mudireddy as a hands-on product analytics case study. It connects an e-commerce storefront with funnel, search, feature-adoption, cohort and experimentation concepts so product decisions can be discussed with evidence rather than assumptions.",
            imgLink:"about-1.jpg",
            imgAlt:""
        },
        {
            title:"Our Mission",
            description:"The product goal is simple: make product discovery easier for shoppers while giving product teams a structured way to understand what users do, where they struggle and which changes are worth testing next.",
            imgLink:"about-2.jpg",
            imgAlt:""
        },
        {
            title:"What Sets Us Apart",
            description:"ShopSense pairs shopping workflows with a dedicated analytics workspace. The portfolio version includes journey mapping, conversion funnels, search analytics, feature adoption, product diagnostics and an A/B testing view, with optional event persistence in PostgreSQL.",
            imgLink:"about-3.jpg",
            imgAlt:""
        }
        ...
        listPoints:[
            {
                ...
                description:"Customer behavior is treated as a signal to investigate, not a reason to jump to conclusions. Metrics are paired with product questions and UX hypotheses."
            },
            {
                title:"Honest measurement",
                description:"The portfolio separates seeded demo metrics from live event data so the project does not present invented production results as real evidence."
            },
            {
                title:"Experiment deliberately",
                description:"The project is designed for iterative product work: instrument a behavior, find friction, form a hypothesis, ship a change and evaluate the outcome."
            },
            {
                title:"Accessible by design",
                description:"Accessibility, transparent UX and responsible measurement are treated as product-quality requirements rather than afterthoughts."
            }
        ],
    },
    section3:{
        title:"About this portfolio build",
        description:[
            "Use the analytics workspace to explore the product story behind ShopSense, including funnels, search behavior, customer journeys, cohorts and experiments.",
            "This is a portfolio project, not a live retail business. The original open-source MIT attribution is retained while the ShopSense product and analytics layers document the candidate-specific customization."
        ]
    }
}
